...
uint32_t getWidthcolor3right() {return gimp_image.width;}
uint32_t getHeightcolor3right() {return gimp_image.height;}
uint32_t getBytePerPixelcolor3right() {return gimp_image.bytes_per_pixel;}
const uint8_t *getPixelDatacolor3right() {return &gimp_image.pixel_data[0];}
